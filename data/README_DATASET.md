...
All fields below are the app's existing contract — see `AML_DATASET_PLAN.md` at repo root for the extraction process. No field names or types changed.
...
*Generated by `scripts/generate-dataset.js` with `RANDOM_SEED = 42`. See `AML_DATASET_PLAN.md` at repo root for the Phase 1 contract-extraction and design document.*
